...
## About Me
I’m a fresh graduate from IPB University, majoring in Agro-industrial Engineering. While studying, I was interested in the application of data science, IoT, cloud, and ERP in the industry. This interest led me to become an assistant in various college-related courses. This experience honed my communication skills, teamwork, time management, and ability to analyze data. To improve my data science skill, I also participated in various programs from trusted institutions such as data analytics and operations boot camp, google data analytics specialization, and machine learning developer.
